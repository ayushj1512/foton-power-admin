...
export default function ActiveCouponsPage() {
  ...
  useEffect(() => {
    ...
    fetchCoupons({ status: "active", page: 1 }).catch(() => {});
  ...
  return (
    <div className="min-h-screen bg-[#f6f6f4] px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
      <div className="space-y-6">
        <section className="rounded-[28px] bg-gradient-to-br from-emerald-950 via-emerald-900 to-zinc-900 px-6 py-6 text-white shadow-[0_20px_60px_rgba(0,0,0,0.18)] sm:px-7 sm:py-7">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <h1 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
                Running coupon campaigns
              </h1>
              <p className="mt-2 max-w-2xl text-sm text-white/70 sm:text-base">
                All live and currently active coupons in one clean view.
              </p>
            </div>
        ...
        {loading ? (
          <div className="flex items-center justify-center rounded-[28px] bg-white px-6 py-16 shadow-[0_10px_30px_rgba(0,0,0,0.04)] ring-1 ring-black/5">
            ...
            <span className="text-sm text-zinc-500">Loading active coupons...</span>
          </div>
          ...
          <div className="rounded-[28px] bg-white px-6 py-16 text-center shadow-[0_10px_30px_rgba(0,0,0,0.04)] ring-1 ring-black/5">
            ...
            <p className="mt-2 text-sm text-zinc-500">
              Create a coupon or activate an existing one.
            </p>
          </div>
        ) : (
